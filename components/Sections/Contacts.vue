          ...
          <div class="mb-10 xl:mb-20">
            ...
            <div class="">
              <div class="flex items-center mb-2">
                ...
                <a href="tel:+48502428693" class="text-base lg:text-2xl">+48 502 428 693</a>
              </div>
              <div class="flex items-center">
                ...
                <a href="mailto:zozulia.yaryna@whitestar-realestate.com" class="text-base lg:text-2xl">zozulia.yaryna@whitestar-realestate.com</a>
              </div>
            </div>
          </div>
          ...
          <div class="">
            ...
            <div class="">
              <div class="flex items-center mb-2">
                ...
                <a href="tel:+48509257257" class="text-base lg:text-2xl">+48 509 257 257</a>
              </div>
              <div class="flex items-center">
                <div class="bg-[#4F9CF9] w-8 h-8 rounded-[50%] mr-2 flex items-center justify-center">
                  <svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="mailto:marciniak.pawel@whitestar-realestate.com" class="text-base lg:text-2xl">marciniak.pawel@whitestar-realestate.com</a>
              </div>
            </div>
          </div>
        </div>
